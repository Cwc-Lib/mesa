...
//maeiky
  WINGDIAPI WINBOOL  wglCopyContext(HGLRC,HGLRC,UINT);
  WINGDIAPI HGLRC  wglCreateContext(HDC);
  WINGDIAPI HGLRC  wglCreateLayerContext(HDC,int);
  WINGDIAPI WINBOOL  wglDeleteContext(HGLRC);
  WINGDIAPI HGLRC  wglGetCurrentContext(VOID);
  WINGDIAPI HDC  wglGetCurrentDC(VOID);
  WINGDIAPI PROC  wglGetProcAddress(LPCSTR);
  WINGDIAPI WINBOOL  wglMakeCurrent(HDC,HGLRC);
  WINGDIAPI WINBOOL  wglShareLists(HGLRC,HGLRC);
  WINGDIAPI WINBOOL  wglUseFontBitmapsA(HDC,DWORD,DWORD,DWORD);
  WINGDIAPI WINBOOL  wglUseFontBitmapsW(HDC,DWORD,DWORD,DWORD);
  WINGDIAPI WINBOOL  SwapBuffers(HDC);
...
//maeiky
  WINGDIAPI WINBOOL  wglUseFontOutlinesA(HDC,DWORD,DWORD,DWORD,FLOAT,FLOAT,int,LPGLYPHMETRICSFLOAT);
  WINGDIAPI WINBOOL  wglUseFontOutlinesW(HDC,DWORD,DWORD,DWORD,FLOAT,FLOAT,int,LPGLYPHMETRICSFLOAT);
...
//maeiky
  WINGDIAPI WINBOOL  wglDescribeLayerPlane(HDC,int,int,UINT,LPLAYERPLANEDESCRIPTOR);
  WINGDIAPI int  wglSetLayerPaletteEntries(HDC,int,int,int,CONST COLORREF *);
  WINGDIAPI int  wglGetLayerPaletteEntries(HDC,int,int,int,COLORREF *);
  WINGDIAPI WINBOOL  wglRealizeLayerPalette(HDC,int,WINBOOL);
  WINGDIAPI WINBOOL  wglSwapLayerBuffers(HDC,UINT);
...
#define WGL_SWAPMULTIPLE_MAX 16
  ...
  WINGDIAPI DWORD  wglSwapMultipleBuffers(UINT,CONST WGLSWAP *);
#endif
